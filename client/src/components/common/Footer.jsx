    ...
    <footer className="relative bg-[#0E0E0E] text-[#B0B7C3] pt-16 pb-8 overflow-hidden border-t border-[#2A2D34]">
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="mt-12 border-t border-[#2A2D34] pt-6 text-center text-sm">
          ...
          {/* CTA row (optional): Electric Blue → Aqua for newsletter or similar */}
          {/* <div className="mt-4 flex justify-center">
            <Link
              to="/contact"
              className="px-5 py-2 rounded-2xl font-semibold bg-gradient-to-r from-[#1A73E8] via-[#3DF5FF] to-[#1A73E8] text-black hover:opacity-95 transition"
            >
              Contact Us
            </Link>
          </div> */}
