    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          <h2 className="text-6xl font-extrabold italic tracking-wider text-blue-600 mb-3">
            MBR34
          </h2>
          <h3 className="text-xl text-gray-700 tracking-wide mb-6">
          ...
          <button
            ...
            className="px-6 py-3 bg-blue-600 text-white font-bold hover:bg-black transition-colors"
          >
            TEAM HISTORY
          </button>
        </div>
